...
CREATE TABLE municipio (
  id INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
  edo_id INTEGER UNSIGNED NOT NULL,
  nombre VARCHAR(100) NOT NULL,
  PRIMARY KEY(id),
  INDEX municipio_FKIndex1(edo_id),
  FOREIGN KEY(edo_id)
    REFERENCES edo(id)
      ON DELETE CASCADE
      ON UPDATE CASCADE
...
CREATE TABLE fiscal (
  ...
  PRIMARY KEY(id),
  INDEX fiscal_FKIndex1(municipio_id),
...
CREATE TABLE dependencia (
  ...
  saved_at DATETIME NOT NULL DEFAULT ''0000-00-00'',
  modified_in DATETIME NULL DEFAULT ''0000-00-00'',
